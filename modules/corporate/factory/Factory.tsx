      ...
      <div className="py-[60px] md:py-[120px] px-0 sm:px-6 container mx-auto space-y-8 md:space-y-20">
        <div className="container space-y-6 md:space-y-12">
          ...
          <div className="flex flex-col gap-6 md:flex-row">
            <p className="md:py-[62px] flex-1 text-[15px] md:text-base -tracking-[0.02em] whitespace-pre-line">{`第二工場の敷地は約14,000平方メートル、工場の建築面積は約4,500平方メートルです。工場の中は製缶部門、マシニング加工部門、旋盤加工部門の三つに分けられ、各部門の面積は、約15メートル×90メートルとなっております。
                また、30トン（20トン＋10トン）クレーンおよび10トンと5トンのクレーンを各部屋に複数設置し、クレーン楊程は12メートルとしたため、大型機器の製缶および機械加工が可能となりました。`}</p>
