...
import WeldingCard from "./WeldingCard";
      ...
      <div className="relative mt-10">
        ...
        >
          <p className="flex flex-col text-white absolute bottom-1/4 left-8 md:left-1/2 md:-translate-x-1/2">
            ...
            <span className="text-jp-h1 text-[20px] md:text-[36px]">溶接</span>
          </p>
        </div>
      ...
      <div className="py-[60px] md:py-[120px]">
        <div className="container mx-auto">
          <CorporateHeading
            ...
            title={`溶接の強み概要のテキストを
ここに入力する。`}
            description="溶接の強み概要のテキストをここに入力する。溶接の強み概要のテキストをここに入力する。溶接の強み概要のテキストをここに入力する。溶接の強み概要のテキストをここに入力する。"
          />
        </div>
        ...
        <div className="bg-web-light-bg">
          <div className="container mx-auto mt-20 mlg:mt-[200px] py-12 mlg:py-[120px] space-y-12 mlg:space-y-20">
            ...
            <div className="grid grid-cols-1 gap-12 mlg:grid-cols-2 mlg:gap-6">
              <WeldingCard
                title="材質"
